...
Researchers are encouraged to use these data for analyses of their own. Overtime we will add links to papers that have used the dataset here in the readme. If you do use these data, please drop us a note before you state to let us know. These data are being used in a number of active projects and this can help to ensure any work undertaken is complimentary and duplicative of work underway.
